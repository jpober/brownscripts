...
pylab.subplot(131)
pylab.imshow(a1, interpolation='nearest', aspect='auto', vmin=-4, vmax=0)
pylab.subplot(132)
pylab.imshow(a2, interpolation='nearest', aspect='auto', vmin=-4, vmax=0)
pylab.subplot(133)
pylab.imshow(a1-a2, interpolation='nearest', aspect='auto')
pylab.show()
