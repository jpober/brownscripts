PRO paper_test,recalculate_all=recalculate_all,export_images=export_images,version=version,_Extra=extra
except=!except
!except=0 
heap_gc
;version='test'
...
;catalog_file_path=filepath('mwa_commissioning_source_list.sav',root=rootdir('FHD'),subdir='catalog_data')
...
freq_end=182. ;182
psf_resolution=32.
;beam_residual_threshold=0.0001
...
mark_zenith=1
;max_cal_iter=100L
;cal_convergence_threshold=1E-5
no_restrict_cal_sources=1
;antenna_size=2.34
