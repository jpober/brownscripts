...
#SBATCH -J FastHoloDeconv
####SBATCH --mail-type=ALL
###SBATCH --mail-user=josh_kerrigan@brown.edu
...
obs_id=${obsids[0]}
echo $version
/usr/local/bin/idl -IDL_DEVICE ps -quiet -IDL_CPU_TPOOL_NTHREADS $ncores -e generate_eor_sourcelist -args $obs_id $outdir $version
