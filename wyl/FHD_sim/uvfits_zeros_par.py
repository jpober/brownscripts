...
altitude = [76.2838]*16+[83.1912]*15+[90.0]*15+[83.1912]*15+[76.2838]*15+[69.1655]*18
azimuth = [90.0]*31+[0.0]*15+[270.0]*48
obsidlist = ['2061311664.uvfits',
             '2061311784.uvfits',
             '2061311904.uvfits',
             '2061312032.uvfits',
             '2061312152.uvfits',
...
for key, val in _sim_params.iteritems():
    if key in default_attrs:
        ...
        uvp = UVParameter(key, description=key)
    uvp = val
    setattr(uvd,key,uvp)
...
hdu[0].header['OBSRA'] = RAlist[en-1]
hdu[0].header['DEC'] = DEClist[en-1]
hdu[0].header['OBSDEC'] = DEClist[en-1]
hdu[0].header['ALTITUDE'] = altitude[en-1]
hdu[0].header['AZIMUTH'] = azimuth[en-1]
