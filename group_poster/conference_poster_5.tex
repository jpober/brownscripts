...
\caption{Deep Full Convolutional Neural Network (D-FCN) architecture design for application to interferometric visibilities. }
\label{fig:DFCNArch}
\end{figure}
...
\frame{\includegraphics[width=1.0\linewidth]{figures/f299.png}}
