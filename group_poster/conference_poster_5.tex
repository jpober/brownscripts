...
\begin{tabular}[t]{l@{}}
\includegraphics[width=15cm]{brown-logo.png} % Logo or a photo of you, adjust its dimensions here
\end{tabular}
\end{minipage}
...
\caption{Precision Array for Probing the Epoch of Reioniation (PAPER) - Located in South Africa in the Karoo desert, consists of 128 dipole antennas and is considered a $1^{st}$ generation radio telescope array.}
\end{figure}
...
\caption{Hydrogen Epoch of Reionization Array (HERA) - Located at the same site as PAPER in the Karoo desert. The current phase of HERA consists of 19 dual polarization dish receivers}
\end{figure}
